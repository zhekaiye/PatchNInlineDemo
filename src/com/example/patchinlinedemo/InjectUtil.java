...
public class InjectUtil {
	...
	public static final String APP_ROOT = "/data/data/com.example.patchinlinedemo/files";
	...
	public static boolean inject(Application context, String dexFileName, String fooClass, boolean isAppend) {
		...
		Log.d("PatchInlineDemo", "InjectUtil inject copy dex from assets successful.");
		
		try {
			Class.forName("dalvik.system.LexClassLoader");
			return injectInAliyunOs(context, file.getAbsolutePath(), fooClass, isAppend);
		} catch (ClassNotFoundException e) {
			//Log.d("PatchInlineDemo", "InjectUtil find LexClassLoader ClassNotFoundException=" + e);
		}
		boolean hasBaseDexClassLoader = true;
		try {
			Class.forName("dalvik.system.BaseDexClassLoader");
		} catch (ClassNotFoundException e) {
			//Log.d("PatchInlineDemo", "InjectUtil find BaseDexClassLoader ClassNotFoundException=" + e);
    ...
    private static boolean injectBelowApiLevel14(Application app, String libPath, String fooClass, boolean isAppend) {
		...
		try {
			...
			Log.d("PatchInlineDemo", "InjectUtil injectBelowApiLevel14 Throwable=" + e);
			e.printStackTrace();
			return false;
		}
	}
    ...
    private static boolean injectAboveEqualApiLevel14(Application app,
		...
		try {
			...
			Log.d("PatchInlineDemo", "InjectUtil injectAboveEqualApiLevel14 Throwable=" + e);
			return false;
		} 
	}
